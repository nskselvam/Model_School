...
export const valuationApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        postBankDetailsIfscUpsert: builder.mutation({
            query: (data) => ({
                url: `/api/dashboard/user/bank-details-ifsc`,
                method: "POST",
                body: data,
            }),
        }),
