...
import { FaMapMarkerAlt, FaArrowRight, FaBuilding } from 'react-icons/fa'
...
const DistrictOfficials_Common_Dashboard = () => {
            ...
            <Card className="shadow-lg border-0 rounded-4 mb-4" style={{ overflow: 'hidden' }}>
              <Card.Body className="p-5">
                ...
                <div className="text-center mb-4">
                  ...
                  <h2 className="fw-bold mb-1" style={{ color: '#f5576c' }}>District Officials Dashboard</h2>
                ...
                <Form.Group className="mb-4">
                  <Form.Label className="fw-bold mb-3" style={{ fontSize: '1.1rem' }}>
                    <FaMapMarkerAlt className="me-2" style={{ color: '#f5576c' }} />
                  ...
                  {myDistrict ? (
                    ...
                    >
                      <div className="d-flex align-items-center justify-content-between">
                        <div>
                          <Badge style={{ background: '#f5576c' }} className="me-2 fs-6">{myDistrict.DCODE}</Badge>
                          <span className="fw-semibold fs-5">{myDistrict.DNAME}</span>
                        </div>
                        <FaMapMarkerAlt size={24} color="#f5576c" />
                      </div>
                    </div>
                  ) : (
...
export default DistrictOfficials_Common_Dashboard
