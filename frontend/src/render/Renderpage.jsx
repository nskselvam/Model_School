...
import IdleTimeoutManager from '../components/IdleTimeoutManager/IdleTimeoutManager'
...
const Renderpage = () => {
  ...
  return (
    <>
      {/* Idle Timeout Manager - monitors activity and auto-logout */}
      <IdleTimeoutManager />
      
      {showNavbar ? (
        userinfo && userinfo.selected_course && !LoginScreen ? (
